...
<body >
        ...
        <div class="card align-content-center col-md-12">
            ...
            <div class="col-md-4">
                ...
                <form class="uk-form-stacked uk-margin-medium-top" method = 'POST' id="platform" action='{!!route("UploadImage")!!}' accept-charset="UTF-8" enctype="multipart/form-data">


                {{ Form::open(['action' => 'EventController@UploadImage']) }}
